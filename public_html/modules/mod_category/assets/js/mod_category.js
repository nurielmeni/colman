  ...
  function getJobContentByCat(
    ...
    jQuery
      .ajax({
        ...
        beforeSend: function () {
            catBlock
              .find(".domain-modul-box-info")
              .before(
                '<progress class="pure-material-progress-linear category" style="margin-bottom: 20px;"></progress>'
              );
          },
        //async: false,
        data: {
      ...
      .done(function (res) {
        ...
        if (isContentChange) {
          ...
          if (obj.jobs.length != 0) {
            ...
            var noResult = $(document.createElement("p")).addClass(
              "popup_noresult"
            );
          ...
          $.get(source, function (data) {
            ...
            setSearchCount(
              allContent.find(".popup_head").find(".count_placeholder"),
              obj.TotalHits
            );
          });
        }
      ...
      .always(function() {
        catBlock
        .find("progress.pure-material-progress-linear")
        .remove();
      });
  }
